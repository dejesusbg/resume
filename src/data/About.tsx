export const bio = `
  ...
  In my spare time, I'm usually listening to 
  <span id="song">[The Marías](https://open.spotify.com/track/3siwsiaEoU4Kuuc9WKMUy5)</span>,
  exercising, or exploring emerging tech to refine my coding skills and plan my next [software project](/resume.pdf).
`;
